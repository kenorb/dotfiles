...
If a regular file or directory already exists in your home directory (e.g., an existing `.bashrc` that is not a symlink), the playbook will **not** overwrite it. Instead:
